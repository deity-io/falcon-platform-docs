...
When you save an encrypted value, it will be displayed in your Console as ***. You will not be able to see what value you saved. Therefore, if you want to edit the value, you can clear the current encrypted value and set a new one.
...
<aside> 💡 We recommend to keep the integration’s prefix as is. If you alter the prefix, the variable will show up in your global custom variables, instead of in the particular integration.
