...
- An [NPM auth token](/docs/platform/getting-started/npm) to access packages from <a href="https://npm.deity.io" target="_blank" rel="noreferrer noopener">https://npm.deity.io</a>. You can get this from your admin panel.
