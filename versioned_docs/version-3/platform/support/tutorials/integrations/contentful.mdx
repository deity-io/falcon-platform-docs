...
Learn about our config files [here](/platform/client/configuration).
...
If you're using Deity Cloud then this is very easy, [see](/platform/cloud/dcloud#environment-variable).
