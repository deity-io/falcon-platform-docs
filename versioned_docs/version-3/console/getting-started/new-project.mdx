...
Once you've completed set-up of your Deity account, you’ll see a list of projects to choose from, or you’ll directly see the specific project dashboard you’ve been granted access to.</p>

## Steps to take

Now that you have a basic understanding of how projects are organised in Deity Platform, you can start building your digital experiences with Deity Commerce Composer and additional Deity building blocks.
...
[Read more →](/docs/console/cloud/about)