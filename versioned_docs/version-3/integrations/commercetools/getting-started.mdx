...
Once familiar with Commercetools, start the integration by [configuring your Falcon Middleware](/integrations/commercetools/configuration/getting-started).

If you reach a point where it is necessary for you to extend our integration, you can have a look at the [documentation](/integrations/commercetools/extending/getting-started).
