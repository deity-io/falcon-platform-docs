...
We **highly recommend** using [`@deity/falcon-payments`](falcon-payments/overview) as this will provide the most flexibility and we are continuously adding support for new payment providers.
