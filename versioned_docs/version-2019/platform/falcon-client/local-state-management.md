...
This page covers how to manage your local (client-side) state. If you're looking for information about querying or mutating data through a server, you can read more about that [here](/docs/2019/platform/falcon-client/data-management).
...
If you already know how to use Apollo Client, you pretty much know how to use it with Falcon. If you need a refresher, continue to the [long version](/docs/2019/platform/falcon-client/local-state-management#the-long-version) or the [Apollo documentation](https://www.apollographql.com/docs/react/v2.5/essentials/get-started/). We also provide a few [additional components](/docs/2019/platform/falcon-client/local-state-management#falcons-additional-components) you can use.
