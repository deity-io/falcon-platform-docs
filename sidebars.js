...
module.exports = {
  ...
  falconOpenSourceSidebar: {
    ...
    Payments: [
      "2019/payments/intro",
      "2019/payments/api",
      "2019/payments/plugins",
    ],
    Backend: [
      "2019/backend/installing-magento2",
      "2019/backend/installing-wordpress",
    ],
    Miscellaneous: [
      "2019/miscellaneous/falcon-logger",
      "2019/miscellaneous/config",
    ],
    Deployment: ["2019/deployment/intro"],
    Support: [
      "2019/support/troubleshooting",
      "2019/support/flowcharts",
    ],
  }
};
