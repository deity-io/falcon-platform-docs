...
Payment methods can be retrieved from your shop backend. Falcon can simply display a UI and pass order details to the backend via DEITY Middleware. These are processed using your shops backend and NOT by Falcon.
