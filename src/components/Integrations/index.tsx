...
const integrations = [
  {
    name: 'Adyen',
    url: '/dpsg/docs/providers/adyen',
    logo: <AdyenLogo />,
    isActive: true
  },
  {
    name: 'Mollie',
    url: '/dpsg/docs/providers/mollie',
    logo: <MollieLogo />,
    isActive: true
  },
  {
    name: 'stripe',
    url: '/dpsg/docs/providers/stripe',
    logo: <StripeLogo />,
    isActive: true
  },
  {
    name: 'braintree',
    url: '/dpsg/docs/providers/braintree',
    logo: <BraintreeLogo />,
    isActive: false
  }
];
  ...
  if (integrations) {
    const integrationContent = integrations.map(integration => {
      if (integration.isActive) {
        return (
          <Link className={styles.integration} to={integration.url} key={integration.name} title={integration.name}>
            {integration.logo}
          </Link>
        );
      }
      ...
      return (
        <div className={`${styles.integration} ${styles.integrationDisabled}`} key={integration.name}>
    ...
    return <div className={styles.integrationsInner}>{integrationContent}</div>;
  }
