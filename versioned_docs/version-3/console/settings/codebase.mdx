...
---
If you’ve followed the Getting Started instructions, you’ve successfully set-up your Deity project and connected it to your Git repository.
...
Copy the SSH key, and add it as a read-only deploy key to your repository.

Next up, you’ll want to copy the webhook URL. Add it to your repository, set the content type to application/json and select the git push event to trigger the webhook.
