...
Payments can be handled in 2 ways, either via your shop or using our payments package, [`@deity/falcon-payments`](falcon-payments).

We **highly recommend** using [`@deity/falcon-payments`](falcon-payments) as this will provide the most flexibility and we are continuously adding support for new payment providers.
...
[Learn more about `@deity/falcon-payments`](falcon-payments)
