...
<p className="desc pb20">
  Once you have completed the set-up of your Deity account, you will see a list of projects to choose from, or you will
  directly see the specific project dashboard you have been granted access to.
</p>
