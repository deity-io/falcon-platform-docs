---
id: sign-up
title: Sign up for Deity Platform
description: Sign up for a Deity account and start developing
...
<p class="desc pb20">Manage your subscriptions, users, deployments, integrations and more with our web-based application.</p>
