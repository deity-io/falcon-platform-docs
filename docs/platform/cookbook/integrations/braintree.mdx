...
import HighlightFlag from '@site/src/components/HighlightFlag';
...
### 4. Passing config data to the frontend (DEITY PWA Frontend)
...
We can use the `initialize` method to pass data from the provider to our DEITY PWA Frontend components.
