---
id: themaeble-component
title: Creating a themeable component
sidebar_label: Creating a themeable component
---

:::note React version
In this guide we're going to be using **React hooks** added in React v16.8. If you're using the old demo you will have to convert these to lifecycle functions (e.g. `componentWillMount`).
:::
