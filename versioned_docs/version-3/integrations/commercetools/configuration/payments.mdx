...
With our existing setup all payments should go through our [payment service](/payments).
...
We explained the [installation process here](/integrations/commercetools/getting-started#commercetools-postman-collection).
