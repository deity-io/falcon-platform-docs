...
Before you get started, we recommend reading the [developer resources of Commercetools](/docs/next/platform/integration/commercetools/resources) to understand the core concepts.
