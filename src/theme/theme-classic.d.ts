...
declare module '@docusaurus/theme-classic' {
  ...
  export default function themeClassic(context: LoadContext, options: Options): Plugin<undefined>;
}
...
declare module '@theme/BlogPostItem/Footer/ReadMoreLink' {
  ...
  export default function BlogPostItemFooterReadMoreLink(props: Props): JSX.Element | null;
}
...
declare module '@theme/DocPage/Layout/Sidebar/ExpandButton' {
  ...
  export default function DocPageLayoutSidebarExpandButton(props: Props): JSX.Element;
}
...
declare module '@theme/Navbar/ColorModeToggle' {
  ...
  export default function NavbarColorModeToggle(props: Props): JSX.Element | null;
}
...
declare module '@theme/NavbarItem/DocNavbarItem' {
  ...
  export default function DocsSidebarNavbarItem(props: Props): JSX.Element | null;
}
...
declare module '@theme/TOCCollapsible/CollapseButton' {
  ...
  export default function TOCCollapsibleCollapseButton(props: Props): JSX.Element;
}
