...
## 4. Add your UI components
The final step is to add your [UI components](../ui) to Falcon Client and start processing payments. The best place to start is using one of our examples apps.
