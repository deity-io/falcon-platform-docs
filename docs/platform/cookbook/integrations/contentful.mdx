...
We recommend you go through [the json placeholder](/docs/platform/cookbook/integrations/jsonplaceholder) example first as it explains the basics of writing an extension and we will be skipping past a few details.
:::
...
[The json placeholder](/docs/platform/cookbook/integrations/jsonplaceholder) example covers this section in more detail.
...
As before, this section is largely covered in [the json placeholder](/docs/platform/cookbook/integrations/jsonplaceholder) example.
