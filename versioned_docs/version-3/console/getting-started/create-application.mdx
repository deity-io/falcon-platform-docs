...
<div class="mb20">
 <Card variant="horizontal" to="">
 	<span style={{height:56}}><img src="/docs/img/icons/adobe.svg" className="round-icon" /></span>&nbsp;+&nbsp;
 	<span style={{height:56}} className="brighten"><img src="/docs/img/icons/deity.svg" className="round-icon" /></span>&nbsp;+&nbsp;
    <span style={{height:56}}><img src="/docs/img/icons/wordpress.svg" className="round-icon" /></span>
    <div>
      <h5>demo-v1</h5>
      <p>
 ...
 <Card variant="horizontal" to="">
    <span style={{height:56}}><img src="/docs/img/icons/bigcommerce.svg" className="round-icon" /></span>&nbsp;+&nbsp;
    <span style={{height:56}} className="brighten"><img src="/docs/img/icons/deity.svg" className="round-icon" /></span>&nbsp;+&nbsp;
    <span style={{height:56}}><img src="/docs/img/icons/algolia.svg" className="round-icon" /></span>
    <div>
      <h5>demo-v2</h5>
      <p>
 ...
 <Card variant="horizontal" to="">
   	<span style={{height:56}}><img src="/docs/img/icons/commercetools.svg" className="round-icon" /></span>&nbsp;+&nbsp;
    <span style={{height:56}} className="brighten"><img src="/docs/img/icons/deity.svg" className="round-icon" /></span>&nbsp;+&nbsp;
    <span style={{height:56}}><img src="/docs/img/icons/contentful.svg" className="round-icon" /></span>
    <div>
      <h5>demo-v3</h5>
      <p>
