...
<h1>
  <a
    href="https://www.unbxd.com/"
    rel="noreferrer noopener"
    target="_blank"
    aria-label="visit the Unbxd site"
    className="invert"
  >
    <img src="/img/docs/platform/unbxd-logo.svg" alt="Unbxd Logo" className="height80 pb20" />
  </a>
</h1>
...
<Button variant="contained" size="medium" href="/integrations/unbxd/getting-started">
  Start reading →
</Button>
...
- [Getting started](/integrations/unbxd/getting-started)
