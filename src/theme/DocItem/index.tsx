...
import useTOCHighlight from '@theme/TOC';
  ...
  return (
    <ul className={isChild ? '' : 'contents contents__left-border'}>
      {headings.map(heading => (
        <li key={heading.id}>
          <a href={`#${heading.id}`} className={LINK_CLASS_NAME} dangerouslySetInnerHTML={{ __html: heading.value }} />
    ...
    <>
      ...
      <div className="padding-vert--lg">
        <div className="container">
          <div className={classnames(styles.contentContainer, 'row')}>
            <div className={classnames('col', styles.docItemCol)}>
              <div className={styles.docItemContainer}>
                <article>
                  {enterpriseOnly && <EnterpriseFlag />}
                  <Breadcrumbs />
                  {!hideTitle && (
                    <header>
