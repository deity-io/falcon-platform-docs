---
id: environments
title: Environments in Cloud Console
...
[Read more about builds & deployments →](../builds-deployments)
...
You can always access the internal URL for review and development purposes. Additionally, you can set multiple custom domains per environment. For instance, you want to use `https://brandname.webshopname.com` to point to one of the environments.

You can set this in the [Storefront → Domains](../storefront/domains) section.
