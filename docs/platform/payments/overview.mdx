...
- A [Payment Provider](/docs/platform/payments/provider) registered in your server config
- A [Payment UI](/docs/platform/payments/ui) that is mapped to a provider
