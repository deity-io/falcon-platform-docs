...
---
If you’ve followed the [Getting Started](../getting-started/deity-project) instructions, you’ve successfully set-up your Deity project and connected it to your Git repository.
