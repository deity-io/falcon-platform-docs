...
* `cache: object` - cache configuration (see [caching section](/docs/2019/platform/falcon-server/caching#cache-adapters))
...
> Read more on how to write your own API Provider [here](/docs/2019/platform/falcon-server/falcon-server-api#apidatasource)
...
> Read more on how to write your own Extension [here](/docs/2019/platform/falcon-server/falcon-server-api#extension)
...
> Read more on how to write your own Endpoint [here](/docs/2019/platform/falcon-server/falcon-server-api#extension)
