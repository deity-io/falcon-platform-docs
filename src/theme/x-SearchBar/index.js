...
const Search = props => {
  ...
  const { placeholder = "Search", position = null, size = null } = props;
  ...
  function initAlgolia(focus) {
    window.docsearch({
      ...
      inputSelector: `#search_input_react_${position}`,
  ...
  return (
    <div className={classnames('navbar__search', `search--${size}`)} key="search-box">
      <span
      ...
      />
      <input
        id={`search_input_react_${position}`}
        type="search"
