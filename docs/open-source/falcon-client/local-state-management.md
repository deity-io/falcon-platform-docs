...
If you already know how to use Apollo Client, you pretty much know how to use it with Falcon. If you need a refresher, continue to the [long version](/docs/open-source/falcon-client/local-state-management#the-long-version) or the [Apollo documentation](https://www.apollographql.com/docs/react/v2.5/essentials/get-started/). We also provide a few [additional components](/docs/open-source/falcon-client/local-state-management#falcons-additional-components) you can use.
