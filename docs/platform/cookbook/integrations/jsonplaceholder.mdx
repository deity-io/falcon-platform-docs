...
For detailed information about integrating with new APIs please [read these docs](/docs/v2019/platform/falcon-server/customizing-extension-api).


## Overview

To add a new data type from a new data source we will need to integrate with a few of DEITY Platform's concepts.
...
## 5. Accessing your data in DEITY PWA Frontend.
