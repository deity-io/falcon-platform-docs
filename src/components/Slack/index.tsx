      ...
      <div className={styles.slackBanner}>
        ...
        <div className={styles.slackBanner__content}>
          ...
          <p>
            ...
            . Our team keep a close eye on this and will usually get back to you within a few hours, if not straight
            away. If you haven&apos;t created an account yet please sign up here{' '}
            <Link href="https://slack.deity.io" target="_blank" rel="noopener noreferrer">
              slack.deity.io
            </Link>
            .
          </p>
